...
global $db, $errors, $full_name, $email,$mobile;
...
// defined below to escape form values
  ...
  if(empty($plan)){
    array_push($errors,"Plan  choose is required");
  }
	if (empty($password_1)) {
	...
	if (count($errors) == 0) {
		...
		if (isset($_POST['user_type'])) {
			...
			$query = "INSERT INTO users (full_name, email,mobile ,plan, password)
					  VALUES('$full_name', '$email', '$mobile','$plan', '$password')";
			mysqli_query($db, $query);
